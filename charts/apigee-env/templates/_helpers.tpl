...
{{- if and .component .component.securityContext .component.securityContext.seccompProfile .component.securityContext.seccompProfile.type -}}
  ...
  {{- end -}}
{{- else if and .env .env.securityContext .env.securityContext.seccompProfile .env.securityContext.seccompProfile.type -}}
  {{- $type = .env.securityContext.seccompProfile.type -}}
  {{- if .env.securityContext.seccompProfile.localhostProfile -}}
  {{- $profile = .env.securityContext.seccompProfile.localhostProfile -}}
  {{- end -}}
